...
Recent profile-store completion/compliance sources: `ai-agents/knowledge-base/pre-s4-player-infra-audit-2026-06-24.md`, `ai-agents/knowledge-base/s4-preexisting-infra-impact-2026-06-24.md`, `ai-agents/tasks/done/s4-profile-04g-argv-concurrency-hardening.md`, `ai-agents/tasks/done/s4-profile-04h-game-server-deploy-env.md`, `ai-agents/tasks/done/s4-profile-05-backend-db-api.md`, `ai-agents/tasks/done/s4-profile-06-match-end-crediting.md`, `ai-agents/tasks/done/s4-personal-data-compliance-investigation.md`, `ai-agents/knowledge-base/personal-data-152fz-findings.md`, `ai-agents/tasks/cancelled/s4-profile-hash-player-ids.md`

## Decision

Sprint 4 is no longer just a future plan. The latest source brief records a mixed state: the two technical investigations are complete, several independent fixes are shipped, multiple side tasks were cancelled, and the backend profile-store path is live through match-end XP crediting. The broader payments/citizenship track still depends on backups, payments/catalog work, UI, and deferred legal/compliance follow-up.
...
| Task | Status | Notes |
|---|---|---|
| Player Profile Store — Implementation | in progress | T1, T3, T4a–T4i, T5, and T6 are done; T2/T7 are cancelled. Remaining prerequisite is T8/backups before paid citizenship scale-up |
...
| Citizenship Core — XP Counter & Progress UI | backlog | Layout and backend crediting are ready; still depends on profile-read UI wiring and production verification discipline |
| Citizenship Core — Earned Citizenship | backlog | Blocked by remaining profile-store operational prerequisites and citizenship UI |
