...
Recent profile-store completion/compliance sources: `ai-agents/knowledge-base/pre-s4-player-infra-audit-2026-06-24.md`, `ai-agents/knowledge-base/s4-preexisting-infra-impact-2026-06-24.md`, `ai-agents/tasks/done/s4-profile-04g-argv-concurrency-hardening.md`, `ai-agents/tasks/done/s4-profile-04h-game-server-deploy-env.md`, `ai-agents/tasks/done/s4-profile-05-backend-db-api.md`, `ai-agents/tasks/done/s4-personal-data-compliance-investigation.md`, `ai-agents/knowledge-base/personal-data-152fz-findings.md`, `ai-agents/tasks/cancelled/s4-profile-hash-player-ids.md`
...
| Task | Status | Notes |
|---|---|---|
| Player Profile Store — Implementation | in progress | T1, T3, T4a–T4i, and T5 are done; T2/T7 are cancelled. Remaining backend path is T6 match-end crediting and T8/backups before paid citizenship scale-up |
...
- T5 is done: profile persistence now has Postgres migrations, a repository, client read endpoint, internal credit endpoint, DB-backed readiness, and typed-column storage. The game server still needs T6 wiring before match-end XP is credited. See [[tasks/profile-backend-db-api]] and [[systems/player-profile-store]].
