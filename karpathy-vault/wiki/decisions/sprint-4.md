...
Recent profile-store completion/compliance sources: `ai-agents/knowledge-base/pre-s4-player-infra-audit-2026-06-24.md`, `ai-agents/knowledge-base/s4-preexisting-infra-impact-2026-06-24.md`, `ai-agents/tasks/done/s4-profile-04g-argv-concurrency-hardening.md`, `ai-agents/tasks/done/s4-profile-04h-game-server-deploy-env.md`, `ai-agents/tasks/done/s4-profile-05-backend-db-api.md`, `ai-agents/tasks/done/s4-profile-06-match-end-crediting.md`, `ai-agents/tasks/done/s4-postgres-backup-routine.md`, `ai-agents/knowledge-base/profile-backup-restore-runbook.md`, `ai-agents/tasks/done/s4-personal-data-compliance-investigation.md`, `ai-agents/knowledge-base/personal-data-152fz-findings.md`, `ai-agents/tasks/cancelled/s4-profile-hash-player-ids.md`
Recent citizenship UI sources: `ai-agents/tasks/done/s4-citizenship-xp-progress-ui.md`, `ai-agents/tasks/done/s4-citizenship-card-guest-cta-no-sdk.md`, `ai-agents/tasks/done/degraded-mode-full-ux-treatment.md`
...
- **Degraded-Mode UX: Yandex SDK timeout/failure treatment is complete.** The card now detects Yandex-platform degraded sessions through `FlashistFacade`, shows connection-problem copy, and suppresses the auth CTA that cannot succeed without an initialized SDK. See [[tasks/degraded-mode-full-ux-treatment]].
...
| Degraded-Mode UX — Yandex SDK timeout/failure treatment | done | Degraded Yandex-platform sessions now show connection-problem copy with no dead login CTA |
| Citizenship Core — Earned Citizenship | backlog | Backend threshold flip exists; inbox/toast notification path remains separate work |
...
- Yandex degraded mode now has its own Sprint 4 treatment: degraded platform sessions show connection-problem copy and no auth CTA instead of being collapsed into the real-guest state
...
- The citizenship card now separates standalone/no-SDK sessions from real Yandex guests and degraded Yandex-platform sessions. The degraded case shows a connection-problem state rather than an actionable login CTA.
...
- [[tasks/degraded-mode-full-ux-treatment]] — shipped Yandex SDK degraded-state treatment for the citizenship card
