...
Follow-up sources: `ai-agents/knowledge-base/plan-fix-archive-endpoint.md`, `ai-agents/knowledge-base/report-archive-endpoint-task-split-2026-06-01.md`, `ai-agents/sprints/sprint-backlog.md`, `ai-agents/tasks/done/s4c-investigate-lobby-map-fetch.md`, `ai-agents/knowledge-base/lobby-map-fetch-investigation-2026-06-03.md`
...
- Production client source maps remain as the main Sprint 4c enablement backlog item before the lower-rate null-id cluster can be triaged reliably.
