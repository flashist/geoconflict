...
| `CITIZENSHIP_TENURE_GRANT_CLAIMED`      | `Citizenship:TenureGrant:Claimed`                            | The profile server **granted** the one-time tenure XP grant — `POST /v1/profile/tenure-grant` answered 200 `granted` (task 0253; ADR-112 as amended 2026-09-15). Never before the server answer. **Value:** the XP awarded (3–50). Fires from `maybeClaimTenureGrant()` (`src/client/TenureGrantClaim.ts`); the thank-you modal opens right after, from the citizenship card                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
