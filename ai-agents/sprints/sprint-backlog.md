...
> including 23 open tasks~~ all 25, of which 21 are still open here (`0026` and `0029` moved to
> [`backlog.md`](backlog.md) 2026-09-26, owner ruling — their rows stay as `➡️ Moved` pointers) — is invisible to the dashboard.** Read this file directly. (Referred to the
...
➡️ **Moved 2026-09-26 to [`backlog.md`](backlog.md)** as `🔲 Backlog`, on the owner rulings recorded in
that task's table row (now `➡️ Moved`). This section is kept as history; the live row is on `backlog.md`.
