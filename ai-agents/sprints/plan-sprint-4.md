...
| 🔄 In Progress | Player Profile Store — Implementation *(epic; T1 ✅, T3 ✅; T2+T7 ⛔ cancelled 2026-06-13 — guest-first dropped, now authenticated-only; T4 ✅ complete 2026-06-24 (T4a–T4i all done; box live at api.geoconflict.ru); next T5 → T6 → T8)* | `s4-player-profile-store-impl.md` |
