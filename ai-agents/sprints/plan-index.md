...
| — | Feedback — attach match history | 1 day | ❌ Excluded | Auto-attach last 3 match IDs to feedback submissions via localStorage; enables archive lookup for bug reports | 3 |
