...
This is one of three match lifecycle enrichment events. The other two are spawn confirmation (`0148-analytics-p0-spawn-confirmation`) and match duration (`0147-analytics-p0-match-duration`).
