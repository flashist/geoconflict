...
## Parent / Epic
`ai-agents/tasks/done/0013-player-profile-store-impl/brief.md` (Part D). **Decomposed from `0178-profile-04e-deploy-mechanics` (T4e)** — the first of three slices that split T4e along the test-assertion boundary (local / on-box / wiring). See postmortem `ai-agents/knowledge-base/profile-deploy-hardening-postmortem-2026-06-19.md`.
