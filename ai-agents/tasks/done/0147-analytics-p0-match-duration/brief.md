...
This is one of three match lifecycle enrichment events. The other two are game mode segmentation (`0146-analytics-p0-game-mode-segmentation`) and spawn confirmation (`0148-analytics-p0-spawn-confirmation`).
