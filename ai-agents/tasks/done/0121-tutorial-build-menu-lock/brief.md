...
- Interaction with action-pause task (`0120-tutorial-action-pause`): both tasks modify tutorial behaviour at tooltip 5. Implement together or coordinate to avoid conflicts.
