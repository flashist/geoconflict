...
sits directly below [`0217`](../../backlog/0217-profile-p2-wire-game-server-to-profile-box/brief.md) on the
...
- **Depends on:** [`0273`](../../backlog/0273-profile-identity-s4-client-login-session-and-bearer-token/brief.md) — profile identity **S4** (client login session + Bearer token), the last link of `0270` → `0271` → `0273` (updated 2026-09-15 when epic [`0266`](../../backlog/0266-profile-identity-internal-player-id-platform-logins-login-endpoint/brief.md) was split into slices on owner rulings relayed by `fkit-lead`). 📌 **2026-09-23: `0273` is CODE-COMPLETE** (built + reviewed 2026-09-16, *"No code"* left). It moved to Sprint 5 for its **live check only**, so this dependency is **satisfied for the local rework**; only `0273`'s production proof is outstanding.
...
- ⚠️ **Why "nothing" above, and what the dependency really is.** Steps 1–2 can run now, and step 3 can
  ...
  [`0217`](../../backlog/0217-profile-p2-wire-game-server-to-profile-box/brief.md) landing **and being
...
- 📌 **REDESIGN — OWNER RULINGS 2026-09-15**, given live in a design discussion in the lead session and
  ...
  - **Follow-ups filed the same day:** [`0266`](../../backlog/0266-profile-identity-internal-player-id-platform-logins-login-endpoint/brief.md)
