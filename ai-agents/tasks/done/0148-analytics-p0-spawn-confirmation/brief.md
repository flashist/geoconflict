...
This is one of three match lifecycle enrichment events. The other two are game mode segmentation (`0146-analytics-p0-game-mode-segmentation`) and match duration (`0147-analytics-p0-match-duration`).
