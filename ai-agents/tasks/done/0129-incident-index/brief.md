...
1. `0130-immediate-containment`

### Parallel after containment

1. `0131-registry-image-exposure-audit`
2. `0132-vps-access-audit-and-hardening`
3. `0133-repo-build-context-hardening`

### After the parallel work

1. `0134-deployment-credential-model-hardening`
2. `0135-clean-rebuild-redeploy-and-validation`
3. `0136-postmortem-wiki-and-follow-ups`
...
- `0137-ci-docker-secret-boundary-check`
- `0138-registry-visibility-and-image-retention-policy`
