...
## Parent / Epic
`ai-agents/tasks/done/0013-player-profile-store-impl/brief.md` (Part D). **Decomposed from `0178-profile-04e-deploy-mechanics` (T4e)** — the keystone on-box slice of the three-way T4e split. See postmortem `ai-agents/knowledge-base/profile-deploy-hardening-postmortem-2026-06-19.md`.
