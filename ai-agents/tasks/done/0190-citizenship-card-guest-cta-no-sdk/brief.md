...
## Sprint
Sprint 4 — follow-up to `0191-citizenship-xp-progress-ui` (done)
...
- Polish/correctness follow-up to the already-shipped `0191-citizenship-xp-progress-ui` — not new scope, no analytics changes.
