...
## Status
⛔ Cancelled (2026-06-13) — guest-first dropped, now authenticated-only; localStorage-authoritative guest store outgrew its slice (see cancellation report 2026-06-13)
