...
Phase 2 of 2. Builds directly on `0033-monitoring-alert-bot-phase1` — it reuses the shared
...
Full background and the two outage families are in `0033-monitoring-alert-bot-phase1`.
...
## References
- Phase 1: `0033-monitoring-alert-bot-phase1`
