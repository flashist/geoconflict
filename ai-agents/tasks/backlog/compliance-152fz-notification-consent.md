...
7. **Retention & deletion.** Right-to-deletion + retention duties, and interaction with the profile
   store and the deferred S3-backed archival (`s4-archive-s3-backed-citizen-gated.md`).
...
- *(The feedback popup contact field is being removed separately — `s4-feedback-remove-contact-field.md`
