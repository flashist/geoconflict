...
|---|---|---|---|---|
| **P0 — Decisions** — ✅ **Done (agent-closed — not owner-verified) 2026-09-14** *(item 4 ruled: the owner runs the profile deploys personally, from their own laptop, VPN off or bypassed)* | [`0214`](../../done/0214-profile-p0-infrastructure-decisions/brief.md) | ~0 eng | — | — |
...
| 🔴 **WORK ORDER 3 of 3** — **P2 — Wire the game server** *(owner-ruled 2026-09-10; it is the step that ENDS the free window — once real citizen rows exist the restore drill and any Postgres work stop being free. ⛔ **LAST IS NOT DEPRIORITIZED** — deliberate sequencing, rank unchanged)* — ✅ **Done (agent-closed — not owner-verified) 2026-09-26** *(V1/V3 met — real match credits landed; residuals: step 4 half, watch item F-B — see the brief)* | [`0217`](../../done/0217-profile-p2-wire-game-server-to-profile-box/brief.md) | 2–4 h + deploy window | Medium | P1 |
| **P5 — Secret persistence + value parity** — ✅ **Done (agent-closed — not owner-verified) 2026-09-26** *(🚩 closed WITH A STATED GAP: §8 step 3 not run live, carried by `0294` — see the brief)* | [`0220`](../../done/0220-profile-p5-secret-persistence-and-value-parity/brief.md) | 0.5–1 day | Medium | P1 |
...
3. `0062`'s D3 *(now `0296` A3 — moved 2026-09-23, owner ruling)* — a real authenticated profile call succeeding end to end in production (P2). ⚠️ The
   ...
   acceptance criterion — [`0217`](../../done/0217-profile-p2-wire-game-server-to-profile-box/brief.md)
