...
Short educational hint clips (GIF or MP4) will be produced as part of `0028-content-hint-videos-production`. The same clean assets can be shown to players inside the game — on the game-starting modal and on the win screen — as a silent, randomly selected hint with a short text caption.
