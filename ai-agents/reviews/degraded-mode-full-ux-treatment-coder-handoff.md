...
Source review: `ai-agents/reviews/degraded-mode-full-ux-treatment.md` (round 2, finding C2). Task: `ai-agents/tasks/done/0049-degraded-mode-full-ux-treatment/brief.md`.
