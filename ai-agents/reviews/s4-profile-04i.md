...
- **None.** #C1 and #A1 were applied 2026-06-23 (process-review closeout — see Decision log). No open defects remain on this slice. The fix is in the working tree, **uncommitted** (workflow rule: commit only on explicit request).
