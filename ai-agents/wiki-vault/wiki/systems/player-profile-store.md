...
> provenance unverified** — and it moves that one statement from *unverified* to *wrong*, not to *fine*. 🔴 **"Clean slate" now means WIPE AND REBUILD ONTO THE EXISTING RESOURCES,
...
- [[tasks/yandex-payments-secret-forwarding]] — task `0195`, the deploy gap that 503s those payments routes; fixed in the repo 2026-09-01 — 🔴 **and as of 2026-09-19 the on-box 503 STATE IS GONE** (a non-empty secret is present). ⚠️ **Presence only: correctness unproven, no real purchase exercised**
