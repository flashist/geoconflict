...
- [[decisions/adr-111-xp-economy-rescale]] — the `1 XP` / `100 XP` rescale `0211` will ship. 🚨 **Bears directly on the rows in THIS store: on the day it lands, any row already at ≥ 100 XP becomes a citizen immediately** — owner-ruled **accepted** 2026-09-11, ⛔ **and NO MIGRATION IS TO BE WRITTEN.** ⚠️ 🔴 **Nothing has shipped** — the constants still read `1000` / `10` (verified 2026-09-11)
