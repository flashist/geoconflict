...
**Implemented 2026-08-14** as task 0019 — see [[tasks/yandex-payments-implementation]] for the shipped catalog cache, profile-server verification endpoints, reconciliation, and the residuals/deferred live verifications.
...
- [[tasks/yandex-payments-implementation]] — the 0019 implementation of these recommendations
