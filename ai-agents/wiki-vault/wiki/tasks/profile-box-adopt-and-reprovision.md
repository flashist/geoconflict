...
| **B9** old bucket contents | **Moot — the old bucket no longer exists.** The owner deleted it before this task's storage work. Its objects were, and remain, unreadable. |
