...
- [[decisions/adr-113-internal-player-id]] — **this decision STANDS** and gains a profile-server seam (`resolveCaller` / login); its rejected option *"a second account system"* is now **partly adopted, deliberately**
