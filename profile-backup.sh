...
# Bytes of a single remote object (empty string if it does not exist).
remote_size() {
...
USAGE
  ...
  # caller-supplied target URL — so this never touches the live DB unless the URL points at it.
