...
# BEFORE running build-deploy-profile.sh (certbot HTTP-01 challenge needs it).
...
# firewall hook; T5 adds the actual route. Game prod = 91.197.98.116,
# game dev = 79.174.91.179.
