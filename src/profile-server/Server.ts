// Player-profile backend API — skeleton (Sprint 4, T4).
//
// This is the ops-foundation slice: a minimal Express service exposing only a
// liveness /health endpoint. The real profile endpoints (GET /v1/profile,
// internal POST /internal/v1/credit) and the Postgres-backed repository land in
// T5. Runs as TypeScript via ts-node ESM, the same way src/server/Server.ts does.
//
...
// Kept dependency-free on purpose — a DB-backed readiness check is added in T5.
